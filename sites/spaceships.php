...
$stmt = Database::instance()->connection()->prepare("SELECT * FROM produkt WHERE kategorieId = 2");
  $stmt->execute(); 
...
<!--Für ALLE sichtbar, Session nicht benötigt-->
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="spaceships.php">Raumschiffe</a></li>
...
?>
  ...
  <h2 class="header2">Raumschiffe</h2>
